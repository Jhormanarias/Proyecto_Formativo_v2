...
namespace ProyectoFormativo
{
...

    {
        ...
        private void btn_Ingreso_U_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                btn_Ingreso_U_Click(sender, e);
            }
        }

        private void btn_Salida_U_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)13)
            {
                btn_Ingreso_U_Click(sender, e);
